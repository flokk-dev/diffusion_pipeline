...
class MyTextDiffuserPage:
    ...
    def __init__(self):
        ...
        self.image_generation: ImageGeneration = ImageGeneration(
            parent=self, diffuser_type=MyTextDiffuser
        )
    ...
    def on_click(
        ...
        self.args = {
            ...
            "mask": utils.resize_image(image_to_mask["mask"][:, :, :3], resolution=512),
            "prompt": prompt,
        ...
        if self.image_generation.diffuser is None:
            self.image_generation.diffuser = MyTextDiffuser(pipeline_id)
    ...
    def __init__(self, parent: Any):
        ...
        with gr.Accordion(label="Images", open=True):
            with gr.Row():
                ...
                self.image = gr.Image(label="Image", tool="sketch", height=350)
